...
>
	<div class="dialog-content" role="dialog" aria-modal="true">
		<button
			class="absolute top-2 right-2 px-4 py-2 rounded font-bold border"
			on:click={closeDialog}
		>
			×
		</button>
		<div class="p-12">
			<p>Tailwind has had 4 different versions of its colour palette.</p>
			<p>
				So the closest Tailwind colour to your hexcode <em>may</em> vary depending on which version of
				Tailwind you're using.
			</p>
			<p>
				Tailwind 4 redefined the palette in the OKLCH colour space, refreshed every shade to be more
				vivid, and added new neutral families (mauve, olive, mist and taupe).
			</p>
			...
			<ul class="list-disc list-inside mt-2 flex flex-col gap-y-2">
				<li>
					<a href="https://tailwindcss.com/docs/colors" target="_blank">Tailwind v4</a>
				</li>
				<li>
					<a href="https://v3.tailwindcss.com/docs/customizing-colors" target="_blank"
						>Tailwind v3.3+</a
					>
				</li>
				<li>
				...
				<li>
					<a href="https://v2.tailwindcss.com/docs/customizing-colors" target="_blank"
						>Tailwind v2</a
					>
				</li>
			</ul>
